...
Communication1 = Spectral.CanCommunication(bustype='slcan', channel='/dev/ttyACM0', bitrate=1000000)
...
while True:
    ...
    if var == 0:
        ...
        Motor1.Send_gripper_data_pack(240,100,500,1,1,0,0) 
        var = 2
    elif var == 2:
        Motor1.Send_gripper_data_pack(0,100,500,1,1,0,0) 
        var = 0
